...
TextLabel_3.Text = "Ставь клавиши на функции как вам нужно! Можно использовать авто-бинд"
...
TextLabel_4.Position = UDim2.new(0.00875273533, 0, 0, 0)
TextLabel_4.Size = UDim2.new(0, 200, 0, 50)
TextLabel_4.Font = Enum.Font.SourceSansBold
TextLabel_4.Text = "Конфигурация"
...
local function VGGTTV_fake_script() -- AutoBind.LocalScript 
...
coroutine.wrap(VGGTTV_fake_script)()
local function CJGWELR_fake_script() -- Back.LocalScript 
...
coroutine.wrap(CJGWELR_fake_script)()
local function THEJ_fake_script() -- FLY.Manager 
...
coroutine.wrap(THEJ_fake_script)()
local function GAOZXK_fake_script() -- AIM.Manager 
...
coroutine.wrap(GAOZXK_fake_script)()
local function HKVTLF_fake_script() -- ESP.Manager 
...
coroutine.wrap(HKVTLF_fake_script)()
local function XGFIPKZ_fake_script() -- NOANCHOR.Manager 
...
coroutine.wrap(XGFIPKZ_fake_script)()
local function NKUTP_fake_script() -- NOCOLLISION.Manager 
...
coroutine.wrap(NKUTP_fake_script)()
local function IVNH_fake_script() -- PLATFORM.Manager 
...
coroutine.wrap(IVNH_fake_script)()
local function LFNNH_fake_script() -- TELEPORT.Manager 
...
coroutine.wrap(LFNNH_fake_script)()
local function THPAJ_fake_script() -- DORSALTELEPORT.Manager 
...
coroutine.wrap(THPAJ_fake_script)()
local function SAMRXY_fake_script() -- CLICKTELEPORT.Manager 
...
coroutine.wrap(SAMRXY_fake_script)()
local function SDGEO_fake_script() -- FLING.Manager 
...
coroutine.wrap(SDGEO_fake_script)()
local function OFRJCT_fake_script() -- XRAY.Manager 
...
coroutine.wrap(OFRJCT_fake_script)()
local function WIYMJB_fake_script() -- SPEED.Manager 
...
coroutine.wrap(WIYMJB_fake_script)()
local function CBEFRYB_fake_script() -- JUMP.Manager 
...
coroutine.wrap(CBEFRYB_fake_script)()
local function XINEH_fake_script() -- CLIENT.Manager 
...
coroutine.wrap(XINEH_fake_script)()
local function JGYYE_fake_script() -- MENUBLUR.Manager 
...
coroutine.wrap(JGYYE_fake_script)()
