...
TextLabel_18.Position = UDim2.new(-3.33890355e-08, 0, 0.923623443, 0)
TextLabel_18.Size = UDim2.new(0, 914, 0, 43)
TextLabel_18.Font = Enum.Font.SourceSansBold
TextLabel_18.Text = "При таком геймплее в некоторых плейсах легко заработать бан."
TextLabel_18.TextColor3 = Color3.fromRGB(36, 38, 48)
...
TextLabel_19.Position = UDim2.new(0.00875273533, 0, 0, 0)
TextLabel_19.Size = UDim2.new(0, 200, 0, 50)
TextLabel_19.Font = Enum.Font.SourceSansBold
TextLabel_19.Text = "Жесткая игра"
	...
	SpeedTextBox.FocusLost:Connect(function(enterPressed)
		...
		if newSpeed then
			...
			StarterGui:SetCore("SendNotification",{
				Title = "Неверный ввод",
				Text = "Введите правильную скорость полета.",
				Duration = 3
			})
		end
	end)
...
local function AFRKBKW_fake_script() -- TELEPORT.ValueManager 
	...
	local SelectFrame2 = script.Parent.Parent.Parent.DorsalTeleport
...
local function BMRZYRS_fake_script() -- DORSALTELEPORT.ButtonManager 
	...
	local Keybind = Instance.new("StringValue", script.Parent.Parent.Parent.Parent.Parent.ConfigValues)
	Keybind.Name = "Keybind_DorsalTeleport"
	
	local OpenFrameButton = script.Parent.Select
	local SelectFrame = script.Parent.Parent.Parent.DorsalTeleport
...
local function FYKZUD_fake_script() -- CLICKTELEPORT.ButtonManager 
	...
	local Keybind = Instance.new("StringValue", script.Parent.Parent.Parent.Parent.Parent.ConfigValues)
	Keybind.Name = "Keybind_ClickTeleport"
...
local function EBKFW_fake_script() -- FLING.ButtonManager 
	...
	local function flingPlayer()
		local playerName = CurrentPlayerValue.Value
		print("Попытка флингнуть игрока: " .. playerName)
		local targetPlayer = Players:FindFirstChild(playerName)
		local localPlayer = Players.LocalPlayer
		...
		if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
			...
			print("Неверный игрок: " .. playerName)
			StarterGui:SetCore("SendNotification", {
				Title = "Ошибка флинга!",
				Text = "Неверный игрок",
				Duration = 3
