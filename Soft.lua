...
local function ETBBBU_fake_script() -- Legit.MiscScript 
...
coroutine.wrap(ETBBBU_fake_script)()
local function UTBVX_fake_script() -- Rage.MiscScript 
...
coroutine.wrap(UTBVX_fake_script)()
local function JJGUW_fake_script() -- Config.MiscScript 
...
coroutine.wrap(JJGUW_fake_script)()
local function YEULHO_fake_script() -- Delete.LocalScript 
...
coroutine.wrap(YEULHO_fake_script)()
local function RATLUE_fake_script() -- Widget.AccountModule 
	...
	local AccountBase = {
		...
		["maga02"] = {password = "1509", role = "user", ip = "YOUR_IP_HERE"}
	}
...
coroutine.wrap(RATLUE_fake_script)()
local function AZFC_fake_script() -- MainPage.Atom.Core 
...
coroutine.wrap(AZFC_fake_script)()
local function MXJO_fake_script() -- MainPage.Dragging 
	local script = Instance.new('LocalScript', MainPage)
...
coroutine.wrap(MXJO_fake_script)()
