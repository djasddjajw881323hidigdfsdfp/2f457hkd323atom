...
local function KOUWGI_fake_script() -- Walkspeed.Manager 
...
coroutine.wrap(KOUWGI_fake_script)()
local function QZJQFAR_fake_script() -- JumpPower.Manager 
...
coroutine.wrap(QZJQFAR_fake_script)()
local function HFAUPWY_fake_script() -- FOV.Manager 
...
coroutine.wrap(HFAUPWY_fake_script)()
local function JRQWQ_fake_script() -- Animation.Manager 
...
coroutine.wrap(JRQWQ_fake_script)()
local function PKKNWT_fake_script() -- SoftButton.ButtonManager 
...
coroutine.wrap(PKKNWT_fake_script)()
local function LWABSMP_fake_script() -- UIListLayout_2.AtomProtection 
...
coroutine.wrap(LWABSMP_fake_script)()
local function BZCWL_fake_script() -- Button_2.ButtonManager 
...
coroutine.wrap(BZCWL_fake_script)()
local function IQRNSL_fake_script() -- Button_4.ButtonManager 
...
coroutine.wrap(IQRNSL_fake_script)()
local function HCLK_fake_script() -- Close.ButtonManager 
...
coroutine.wrap(HCLK_fake_script)()
local function KRIIQ_fake_script() -- Mainframe.Dragging 
...
coroutine.wrap(KRIIQ_fake_script)()
local function MQYUSKP_fake_script() -- SoftButton_2.ButtonManager 
...
coroutine.wrap(MQYUSKP_fake_script)()
local function DPKZQD_fake_script() -- SoftButton_3.ButtonManager 
...
coroutine.wrap(DPKZQD_fake_script)()
local function EGPYWB_fake_script() -- SoftButton_4.ButtonManager 
...
coroutine.wrap(EGPYWB_fake_script)()
local function KKTWY_fake_script() -- SoftButton_5.ButtonManager 
...
coroutine.wrap(KKTWY_fake_script)()
local function OGKYD_fake_script() -- SoftButton_6.A.Debugger 
...
coroutine.wrap(OGKYD_fake_script)()
local function MEDIRQ_fake_script() -- SoftButton_7.ButtonManager 
...
coroutine.wrap(MEDIRQ_fake_script)()
local function YBQWPW_fake_script() -- ValueButton.ValueManager 
...
coroutine.wrap(YBQWPW_fake_script)()
local function YFOTPQU_fake_script() -- TextLabel_23.RamdomText 
...
coroutine.wrap(YFOTPQU_fake_script)()
local function TBWDA_fake_script() -- Owner.Color 
...
coroutine.wrap(TBWDA_fake_script)()
local function IWMHIIA_fake_script() -- TextLabel_28.Name 
...
coroutine.wrap(IWMHIIA_fake_script)()
local function RFNVN_fake_script() -- Mainframe.UiStroke 
	local script = Instance.new('LocalScript', Mainframe)
...
coroutine.wrap(RFNVN_fake_script)()
local function LJMZ_fake_script() -- SoftButton_8.ButtonManager 
...
coroutine.wrap(LJMZ_fake_script)()
local function GGRUNTI_fake_script() -- Atom.Status 
...
coroutine.wrap(GGRUNTI_fake_script)()
local function QUKZRNB_fake_script() -- Button_15.ButtonManager 
...
coroutine.wrap(QUKZRNB_fake_script)()
local function ENIR_fake_script() -- ValueButton_2.ValueManager 
	local script = Instance.new('LocalScript', ValueButton_2)

	
end
coroutine.wrap(ENIR_fake_script)()
local function LQYSD_fake_script() -- Open.Open 
...
coroutine.wrap(LQYSD_fake_script)()
local function SPTTB_fake_script() -- Open.Dragging 
	local script = Instance.new('LocalScript', Open)
...
coroutine.wrap(SPTTB_fake_script)()
local function MDMLH_fake_script() -- Login.Dragging 
...
coroutine.wrap(MDMLH_fake_script)()
local function RBLSG_fake_script() -- Login.AccountModule 
	local script = Instance.new('LocalScript', Login)
...
coroutine.wrap(RBLSG_fake_script)()
local function EKUPH_fake_script() -- Button_17.ButtonManager 
...
coroutine.wrap(EKUPH_fake_script)()
local function MXOXT_fake_script() -- Login.UiStroke 
	local script = Instance.new('LocalScript', Login)
...
coroutine.wrap(MXOXT_fake_script)()
local function UFMEZ_fake_script() -- Discord.ButtonManager 
...
coroutine.wrap(UFMEZ_fake_script)()
local function VNPZS_fake_script() -- ImageLabel_11.LocalScript 
...
coroutine.wrap(VNPZS_fake_script)()
local function HJJW_fake_script() -- TextLabel_37.LocalScript 
	local script = Instance.new('LocalScript', TextLabel_37)

	local TextLabel = script.Parent
	TextLabel.Text = game.Players.LocalPlayer.DisplayName
end
coroutine.wrap(HJJW_fake_script)()
local function HQWO_fake_script() -- TextLabel_38.LocalScript 
	local script = Instance.new('LocalScript', TextLabel_38)

	local TextLabel = script.Parent
	TextLabel.Text = "@"..game.Players.LocalPlayer.Name
end
coroutine.wrap(HQWO_fake_script)()
local function MNRU_fake_script() -- TextLabel_39.LocalScript 
	local script = Instance.new('LocalScript', TextLabel_39)

	local TextLabel = script.Parent
	TextLabel.Text = "ID:"..game.Players.LocalPlayer.UserId
end
coroutine.wrap(MNRU_fake_script)()
local function FBEE_fake_script() -- TextLabel_40.LocalScript 
	local script = Instance.new('LocalScript', TextLabel_40)

	local TextLabel = script.Parent
	TextLabel.Text = game.Players.LocalPlayer.AccountAge.."(D)"
end
coroutine.wrap(FBEE_fake_script)()
local function UKXYLQU_fake_script() -- Execution.Dragging 
...
coroutine.wrap(UKXYLQU_fake_script)()
local function FTHTZ_fake_script() -- Execute.ButtonManager 
...
coroutine.wrap(FTHTZ_fake_script)()
local function IPXWLY_fake_script() -- Execution.UiStroke 
	local script = Instance.new('LocalScript', Execution)
...
coroutine.wrap(IPXWLY_fake_script)()
local function ZCKP_fake_script() -- Clear.ButtonManager 
...
coroutine.wrap(ZCKP_fake_script)()
local function RDGACE_fake_script() -- Execution.ExecutionModule 
	local script = Instance.new('LocalScript', Execution)
...
coroutine.wrap(RDGACE_fake_script)()
